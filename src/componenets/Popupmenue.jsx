...
const Popupmenue = ({ navlinks, popupState }) => {
    return (
        <>
            <nav className={`
            ...
            `}>
                <ul className='flex items-start flex-col gap-3'>
                    ...
                    <li><button type='button' className='button-light shadow-slate-400 sm:w-auto rounded-lg justify-center'>Join Us</button></li>
                </ul>
            </nav>
        </>
    )
